...
function a(e, n, t) {
  ...
  if(arguments.length > 3) for(t = [t], _ = 3; _ < arguments.length; _++) t.push(o[_]);
  if((null != t && (r.children = t), 'function' == typeof e && null != e.defaultProps)) for(_ in e.defaultProps) void 0 === r[_] && (r[_] = e.defaultProps[_]);
  return p(e, r, n && n.key, n && n.ref, null);
}
function p(n, t, _, o, r) {
  var u = { type: n, props: t, key: _, ref: o, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: r };
...
function k(e, n, t, _, o, r, u, c, s) {
  var a,
    ...
    k = (t && t.__k) || i,
    x = k.length;
  if((c == l && (c = null != r ? r[0] : x ? v(t, 0) : null),
    (a = 0),
    (n.__k = b(n.__k, function (t) {
      if(null != t) {
        if(((t.__ = n), (t.__b = n.__b + 1), null === (h = k[a]) || (h && t.key == h.key && t.type === h.type))) k[a] = void 0;
        else
          for(p = 0; p < x; p++) {
        ...
        if(((d = H(e, t, (h = h || l), _, o, r, u, c, s)), (p = t.ref) && h.ref != p && (g || (g = []), h.ref && g.push(h.ref, null, t), g.push(p, t.__c || d, t)), null != d)) {
          var i;
          if((null == y && (y = d), void 0 !== t.__d)) (i = t.__d), (t.__d = void 0);
          else if(r == h || d != c || null == d.parentNode) {
            e: if(null == c || c.parentNode !== e) e.appendChild(d), (i = null);
            else {
              for(m = c, p = 0; (m = m.nextSibling) && p < x; p += 2) if(m == d) break e;
...
function b(e, n, t) {
  if((null == t && (t = []), null == e || 'boolean' == typeof e)) n && t.push(n(null));
...
function w(e, n, t, _, o) {
  ...
  if((o ? 'className' === n && (n = 'class') : 'class' === n && (n = 'className'), 'style' === n))
    if(((r = e.style), 'string' == typeof t)) r.cssText = t;
      ...
      if(('string' == typeof _ && ((r.cssText = ''), (_ = null)), _)) for(i in _) (t && i in t) || x(r, i, '');
      if(t) for(c in t) (_ && t[c] === _[c]) || x(r, c, t[c]);
    }
  else
    'o' === n[0] && 'n' === n[1]
      ? ((u = n !== (n = n.replace(/Capture$/, ''))), (l = n.toLowerCase()), (n = (l in e ? l : n).slice(2)), t ? (_ || e.addEventListener(n, C, u), ((e.l || (e.l = {}))[n] = t)) : e.removeEventListener(n, C, u))
      : 'list' !== n && 'tagName' !== n && 'form' !== n && 'type' !== n && 'size' !== n && !o && n in e
      ? (e[n] = null == t ? '' : t)
      : 'function' != typeof t && 'dangerouslySetInnerHTML' !== n && (n !== (n = n.replace(/^xlink:?/, '')) ? (null == t || !1 === t ? e.removeAttributeNS('http://www.w3.org/1999/xlink', n.toLowerCase()) : e.setAttributeNS('http://www.w3.org/1999/xlink', n.toLowerCase(), t)) : null == t || (!1 === t && !/^ar/.test(n)) ? e.removeAttribute(n) : e.setAttribute(n, t));
}
function C(n) {
  ...
  try {
    e: if('function' == typeof C) {
      if(((b = t.props),
        ...
        _.__c ? (g = (a = t.__c = _.__c).__ = a.__E) : ('prototype' in C && C.prototype.render ? (t.__c = a = new C(b, w)) : ((t.__c = a = new d(b, w)), (a.constructor = C), (a.render = N)), x && x.sub(a), (a.props = b), a.state || (a.state = {}), (a.context = w), (a.__n = o), (p = a.__d = !0), (a.__h = [])),
        null == a.__s && (a.__s = a.state),
        null != C.getDerivedStateFromProps && (a.__s == a.state && (a.__s = s({}, a.__s)), s(a.__s, C.getDerivedStateFromProps(b, a.__s))),
        (v = a.props),
        (m = a.state),
        p)
      )
        ...
        if((null == C.getDerivedStateFromProps && b !== v && null != a.componentWillReceiveProps && a.componentWillReceiveProps(b, w), (!a.__e && null != a.shouldComponentUpdate && !1 === a.shouldComponentUpdate(b, a.__s, w)) || (t.__v === _.__v && !a.__))) {
          for(a.props = b, a.state = a.__s, t.__v !== _.__v && (a.__d = !1), a.__v = t, t.__e = _.__e, t.__k = _.__k, a.__h.length && l.push(a), f = 0; f < t.__k.length; f++) t.__k[f] && (t.__k[f].__ = t);
          break e;
        }
      ...
      (a.context = w),
        ...
        (t.__k = null != f && f.type == h && null == f.key ? f.props.children : Array.isArray(f) ? f : [f]),
        null != a.getChildContext && (o = s(s({}, o), a.getChildContext())),
        p || null == a.getSnapshotBeforeUpdate || (y = a.getSnapshotBeforeUpdate(v, m)),
        k(n, t, _, o, r, u, l, i, c),
        (a.base = t.__e),
...
function E(e, n, t, _, o, r, u, c) {
  ...
  if(null === n.type) d !== v && e.data != v && (e.data = v);
    ...
    if((null != r && (r = i.slice.call(e.childNodes)), (a = (d = t.props || l).dangerouslySetInnerHTML), (p = v.dangerouslySetInnerHTML), !c)) {
      if(d === l) for(d = {}, h = 0; h < e.attributes.length; h++) d[e.attributes[h].name] = e.attributes[h].value;
      (p || a) && ((p && a && p.__html == a.__html) || (e.innerHTML = (p && p.__html) || ''));
    }
    (function (e, n, t, _, o) {
      var r;
      for(r in t) 'children' === r || 'key' === r || r in n || w(e, r, null, t[r], _);
      for(r in n) (o && 'function' != typeof n[r]) || 'children' === r || 'key' === r || 'value' === r || 'checked' === r || t[r] === n[r] || w(e, r, n[r], t[r], _);
    })(e, v, d, o, c),
      (n.__k = n.props.children),
      p || k(e, n, t, _, 'foreignObject' !== n.type && o, r, u, l, c),
      c || ('value' in v && void 0 !== v.value && v.value !== e.value && (e.value = null == v.value ? '' : v.value), 'checked' in v && void 0 !== v.checked && v.checked !== e.checked && (e.checked = v.checked));
  }
  return e;
}
function P(n, t, _) {
                ...
                for(var c = 0; c < e[i].length; c++)
                  (n = e[i][c]),
                    1 === _
                      ...
                      : '>' === n
                      ? (l(), (_ = 1))
                      : _ && ('=' === n ? ((_ = 5), (t = o), (o = '')) : '/' === n && (_ < 5 || '>' === e[i][c + 1]) ? (l(), 3 === _ && (u = u[0]), (_ = u), (u = u[0]).push(2, 0, _), (_ = 0)) : ' ' === n || '\t' === n || '\n' === n || '\r' === n ? (l(), (_ = 2)) : (o += n)),
                    3 === _ && '!--' === o && ((_ = 4), (u = u[0]));
              }
              return l(), u;
            })(e))
...
export { a as h, re as html, T as render, d as Component, U as createContext, q as useState, B as useReducer, $ as useEffect, j as useLayoutEffect, z as useRef, G as useImperativeHandle, J as useMemo, K as useCallback, Q as useContext, X as useDebugValue };
