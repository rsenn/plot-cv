...
file(GLOB HIGHGUI_VIEWER_SOURCES src/color.cpp src/data.cpp src/js.cpp
     src/plot-cv.cpp src/matrix.cpp src/polygon.cpp src/*.h)
...
target_link_libraries(
  highgui-viewer ${QUICKJS_OPENCV_A} ${PNG_LIBRARIES}
  ${OPENCV_FREETYPE_LIBRARY} ${OPENCV_LIBRARIES} ${GLEW_SHARED_LIBRARY_RELEASE}
  ${GLEW_SHARED_LIBRARIES} quickjs ${LIBDL} ${LIBM} ${LIBPTHREAD})
