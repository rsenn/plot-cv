...
file(GLOB IMGUI_VIEWER_SOURCES src/color.cpp src/data.cpp src/geometry.cpp src/js.cpp src/jsbindings.cpp src/plot-cv.cpp src/js_*.cpp src/line.cpp src/matrix.cpp src/polygon.cpp src/util.cpp src/*.h
     src/*.hpp)
...
# Main
add_executable(imgui-viewer src/imgui-viewer.cpp imgui/imgui.cpp imgui/imgui_draw.cpp imgui/imgui_widgets.cpp imgui/imgui_impl_sdl.cpp imgui/imgui_impl_opengl3.cpp imgui/libs/gl3w/GL/gl3w.c
...
# link
target_link_libraries(imgui-viewer ${SDL2_LIBRARIES} ${QUICKJS_OPENCV_A} ${PNG_LIBRARIES} ${OPENCV_FREETYPE_LIBRARY} ${OPENCV_LIBRARIES} glfw ${OPENGL_LIBRARIES} ${GLFW_LIBRARIES} ${GLEW_LIBRARIES}
                      ${EXTRA_LIBS} quickjs ${LIBDL} ${LIBM} ${LIBPTHREAD} GL)
