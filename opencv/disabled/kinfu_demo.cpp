...
struct DepthSource {
public:
  enum Type { DEPTH_LIST, DEPTH_KINECT2_LIST, DEPTH_KINECT2, DEPTH_REALSENSE };
  ...
  updateParams(Params& params) {
    if(vc.isOpened()) {
      ...
      if(sourceType == Type::DEPTH_REALSENSE) {
        ...
        params.volumePose = Affine3f().translate(Vec3f(-cubeSize / 2.f, -cubeSize / 2.f, 0.05f));
