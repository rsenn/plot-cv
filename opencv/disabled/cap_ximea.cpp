...
cv::create_XIMEA_capture_cam(int index) {
...
cv::Ptr<cv::IVideoCapture>
cv::create_XIMEA_capture_file(const std::string& serialNumber) {
  CvCaptureCAM_XIMEA* capture = new CvCaptureCAM_XIMEA;
...
bool
CvCaptureCAM_XIMEA::open(int wIndex) {
  if(numDevices == 0)
    return false;
...
bool
CvCaptureCAM_XIMEA::open(const char* serialNumber) {
  if(numDevices == 0)
    return false;
...
void
CvCaptureCAM_XIMEA::resetCvImage() {
  bool do_reset = false;
...
int
CvCaptureCAM_XIMEA::ocvParamtoXimeaParam(int property_id) const {
  ...
  switch(property_id) {
    ...
    case cv::CAP_PROP_POS_FRAMES:
      ...
      return cv::CAP_PROP_XI_COUNTER_VALUE;
    case cv::CAP_PROP_FRAME_WIDTH: return cv::CAP_PROP_XI_WIDTH;
    case cv::CAP_PROP_FRAME_HEIGHT: return cv::CAP_PROP_XI_HEIGHT;
    case cv::CAP_PROP_FPS: return cv::CAP_PROP_XI_FRAMERATE;
    case cv::CAP_PROP_GAIN: return cv::CAP_PROP_XI_GAIN;
    case cv::CAP_PROP_EXPOSURE: return cv::CAP_PROP_XI_EXPOSURE;
    case cv::CAP_PROP_XI_DATA_FORMAT: return cv::CAP_PROP_XI_IMAGE_DATA_FORMAT;
...
bool
CvCaptureCAM_XIMEA::setProperty(int property_id, double value) {
  ...
  switch(property_id) {
    case cv::CAP_PROP_XI_TIMEOUT: timeout = (int)value; return true;
    case cv::CAP_PROP_XI_EXPOSURE:
      ximea_param = "exposure";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_EXPOSURE_BURST_COUNT:
      ximea_param = "exposure_burst_count";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_GAIN_SELECTOR:
      ximea_param = "gain_selector";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_GAIN:
      ximea_param = "gain";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_DOWNSAMPLING:
      ximea_param = "downsampling";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_DOWNSAMPLING_TYPE:
      ximea_param = "downsampling_type";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_BINNING_SELECTOR:
      ximea_param = "binning_selector";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_BINNING_VERTICAL:
      ximea_param = "binning_vertical";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_BINNING_HORIZONTAL:
      ximea_param = "binning_horizontal";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_BINNING_PATTERN:
      ximea_param = "binning_pattern";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_DECIMATION_SELECTOR:
      ximea_param = "decimation_selector";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_DECIMATION_VERTICAL:
      ximea_param = "decimation_vertical";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_DECIMATION_HORIZONTAL:
      ximea_param = "decimation_horizontal";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_DECIMATION_PATTERN:
      ximea_param = "decimation_pattern";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_TEST_PATTERN_GENERATOR_SELECTOR:
      ximea_param = "test_pattern_generator_selector";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_TEST_PATTERN:
      ximea_param = "test_pattern";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_IMAGE_DATA_FORMAT:
      ximea_param = "imgdataformat";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_SHUTTER_TYPE:
      ximea_param = "shutter_type";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_SENSOR_TAPS:
      ximea_param = "sensor_taps";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_AEAG:
      ximea_param = "aeag";
    ...
    case cv::CAP_PROP_XI_AEAG_ROI_HEIGHT:
      ...
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_BPC:
      ximea_param = "bpc";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_AUTO_WB:
      ximea_param = "auto_wb";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_MANUAL_WB:
    ...
    case cv::CAP_PROP_XI_WB_KB:
      ...
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_WIDTH:
      ximea_param = "width";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_HEIGHT:
      ximea_param = "height";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_OFFSET_X:
      ximea_param = "offsetX";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_OFFSET_Y:
      ximea_param = "offsetY";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_REGION_SELECTOR:
      ximea_param = "region_selector";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_REGION_MODE:
      ximea_param = "region_mode";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_EXP_PRIORITY:
      ximea_param = "exp_priority";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_AG_MAX_LIMIT:
      ximea_param = "ag_max_limit";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_AE_MAX_LIMIT:
      ximea_param = "ae_max_limit";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_AEAG_LEVEL:
      ximea_param = "aeag_level";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_LIMIT_BANDWIDTH:
      ximea_param = "limit_bandwidth";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_SENSOR_DATA_BIT_DEPTH:
      ximea_param = "sensor_bit_depth";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_OUTPUT_DATA_BIT_DEPTH:
      ximea_param = "output_bit_depth";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_IMAGE_DATA_BIT_DEPTH:
      ximea_param = "image_data_bit_depth";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_OUTPUT_DATA_PACKING:
      ximea_param = "output_bit_packing";
      value_type = xiTypeBoolean;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_OUTPUT_DATA_PACKING_TYPE:
      ximea_param = "output_bit_packing_type";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_IS_COOLED:
      ximea_param = "iscooled";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_COOLING:
      ximea_param = "cooling";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_TARGET_TEMP:
      ximea_param = "target_temp";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CHIP_TEMP:
      ximea_param = "chip_temp";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_HOUS_TEMP:
      ximea_param = "hous_temp";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_HOUS_BACK_SIDE_TEMP:
      ximea_param = "hous_back_side_temp";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_SENSOR_BOARD_TEMP:
      ximea_param = "sensor_board_temp";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CMS:
      ximea_param = "cms";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_APPLY_CMS:
      ximea_param = "apply_cms";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_IMAGE_IS_COLOR:
      ximea_param = "iscolor";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_COLOR_FILTER_ARRAY:
      ximea_param = "cfa";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_GAMMAY:
      ximea_param = "gammaY";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_GAMMAC:
      ximea_param = "gammaC";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_SHARPNESS:
      ximea_param = "sharpness";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_00:
      ximea_param = "ccMTX00";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_01:
      ximea_param = "ccMTX01";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_02:
      ximea_param = "ccMTX02";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_03:
      ximea_param = "ccMTX03";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_10:
      ximea_param = "ccMTX10";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_11:
      ximea_param = "ccMTX11";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_12:
      ximea_param = "ccMTX12";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_13:
      ximea_param = "ccMTX13";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_20:
      ximea_param = "ccMTX20";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_21:
      ximea_param = "ccMTX21";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_22:
      ximea_param = "ccMTX22";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_23:
      ximea_param = "ccMTX23";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_30:
      ximea_param = "ccMTX30";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_31:
      ximea_param = "ccMTX31";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_32:
      ximea_param = "ccMTX32";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_CC_MATRIX_33:
      ximea_param = "ccMTX33";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_DEFAULT_CC_MATRIX:
      ximea_param = "defccMTX";
      value_type = xiTypeCommand;
      break;
    case cv::CAP_PROP_XI_TRG_SOURCE:
      ximea_param = "trigger_source";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_TRG_SOFTWARE:
      ximea_param = "trigger_software";
      value_type = xiTypeCommand;
      break;
    case cv::CAP_PROP_XI_TRG_SELECTOR:
      ximea_param = "trigger_selector";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_ACQ_FRAME_BURST_COUNT:
      ximea_param = "acq_frame_burst_count";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_GPI_SELECTOR:
      ximea_param = "gpi_selector";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_GPI_MODE:
      ximea_param = "gpi_mode";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_GPI_LEVEL:
      ximea_param = "gpi_level";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_GPO_SELECTOR:
      ximea_param = "gpo_selector";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_GPO_MODE:
      ximea_param = "gpo_mode";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_LED_SELECTOR:
      ximea_param = "led_selector";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_LED_MODE:
      ximea_param = "led_mode";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_DEBOUNCE_EN:
      ximea_param = "dbnc_en";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_DEBOUNCE_T0:
      ximea_param = "dbnc_t0";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_DEBOUNCE_T1:
      ximea_param = "dbnc_t1";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_DEBOUNCE_POL:
      ximea_param = "dbnc_pol";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_LENS_MODE:
      ximea_param = "lens_mode";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_LENS_APERTURE_VALUE:
      ximea_param = "lens_aperture_value";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_LENS_FOCUS_MOVEMENT_VALUE:
      ximea_param = "lens_focus_movement_value";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_LENS_FOCUS_MOVE:
      ximea_param = "lens_focus_move";
      value_type = xiTypeCommand;
      break;
    case cv::CAP_PROP_XI_LENS_FOCUS_DISTANCE:
      ximea_param = "lens_focus_distance";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_LENS_FOCAL_LENGTH:
      ximea_param = "lens_focal_length";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_LENS_FEATURE_SELECTOR:
      ximea_param = "lens_feature_selector";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_LENS_FEATURE:
      ximea_param = "lens_feature";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_DEVICE_MODEL_ID:
      ximea_param = "device_model_id";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_DEVICE_SN:
      ximea_param = "device_sn";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_IMAGE_DATA_FORMAT_RGB32_ALPHA:
      ximea_param = "imgdataformatrgb32alpha";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_IMAGE_PAYLOAD_SIZE:
      ximea_param = "imgpayloadsize";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_TRANSPORT_PIXEL_FORMAT:
      ximea_param = "transport_pixel_format";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_SENSOR_CLOCK_FREQ_HZ:
      ximea_param = "sensor_clock_freq_hz";
      value_type = xiTypeFloat;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_SENSOR_CLOCK_FREQ_INDEX:
      ximea_param = "sensor_clock_freq_index";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_SENSOR_OUTPUT_CHANNEL_COUNT:
      ximea_param = "sensor_output_channel_count";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_FRAMERATE:
      ximea_param = "framerate";
      value_type = xiTypeFloat;
      break;
    case cv::CAP_PROP_XI_COUNTER_SELECTOR:
      ximea_param = "counter_selector";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_COUNTER_VALUE:
      ximea_param = "counter_value";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_ACQ_TIMING_MODE:
      ximea_param = "acq_timing_mode";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_AVAILABLE_BANDWIDTH:
      ximea_param = "available_bandwidth";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_BUFFER_POLICY:
      ximea_param = "buffer_policy";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_LUT_EN:
      ximea_param = "LUTEnable";
      value_type = xiTypeBoolean;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_LUT_INDEX:
      ximea_param = "LUTIndex";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_LUT_VALUE:
      ximea_param = "LUTValue";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_TRG_DELAY:
      ximea_param = "trigger_delay";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_TS_RST_MODE:
      ximea_param = "ts_rst_mode";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_TS_RST_SOURCE:
      ximea_param = "ts_rst_source";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_IS_DEVICE_EXIST:
      ximea_param = "isexist";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_ACQ_BUFFER_SIZE:
      ximea_param = "acq_buffer_size";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_ACQ_BUFFER_SIZE_UNIT:
      ximea_param = "acq_buffer_size_unit";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_ACQ_TRANSPORT_BUFFER_SIZE:
      ximea_param = "acq_transport_buffer_size";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_BUFFERS_QUEUE_SIZE:
      ximea_param = "buffers_queue_size";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_ACQ_TRANSPORT_BUFFER_COMMIT:
      ximea_param = "acq_transport_buffer_commit";
      value_type = xiTypeInteger;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_RECENT_FRAME:
      ximea_param = "recent_frame";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_DEVICE_RESET:
      ximea_param = "device_reset";
      value_type = xiTypeCommand;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_COLUMN_FPN_CORRECTION:
      ximea_param = "column_fpn_correction";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_ROW_FPN_CORRECTION:
      ximea_param = "row_fpn_correction";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_SENSOR_MODE:
      ximea_param = "sensor_mode";
      value_type = xiTypeEnum;
      doAcqReset = true;
      break;
    case cv::CAP_PROP_XI_HDR:
      ximea_param = "hdr";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_HDR_KNEEPOINT_COUNT:
      ximea_param = "hdr_kneepoint_count";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_HDR_T1:
      ximea_param = "hdr_t1";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_HDR_T2:
      ximea_param = "hdr_t2";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_KNEEPOINT1:
      ximea_param = "hdr_kneepoint1";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_KNEEPOINT2:
      ximea_param = "hdr_kneepoint2";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_IMAGE_BLACK_LEVEL:
      ximea_param = "image_black_level";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_HW_REVISION:
      ximea_param = "hw_revision";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_DEBUG_LEVEL:
      ximea_param = "debug_level";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_AUTO_BANDWIDTH_CALCULATION:
      ximea_param = "auto_bandwidth_calculation";
      value_type = xiTypeBoolean;
      break;
    case cv::CAP_PROP_XI_FFS_FILE_ID:
      ximea_param = "ffs_file_id";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_FFS_FILE_SIZE:
      ximea_param = "ffs_file_size";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_FREE_FFS_SIZE:
      ximea_param = "free_ffs_size";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_USED_FFS_SIZE:
      ximea_param = "used_ffs_size";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_FFS_ACCESS_KEY:
      ximea_param = "ffs_access_key";
      value_type = xiTypeInteger;
      break;
    case cv::CAP_PROP_XI_SENSOR_FEATURE_SELECTOR:
      ximea_param = "sensor_feature_selector";
      value_type = xiTypeEnum;
      break;
    case cv::CAP_PROP_XI_SENSOR_FEATURE_VALUE:
  ...
  switch(value_type) {
    ...
    case xiTypeFloat: // float parameter type
      ...
      break;
    default: errMsg("CvCaptureCAM_XIMEA::setProperty", XI_WRONG_PARAM_TYPE); setProp_result = false;
  }
...
double
CvCaptureCAM_XIMEA::getProperty(int property_id) const {
  XI_RETURN stat = XI_OK;
  double getPropVal = 0;
  int ival = 0;
  float fval = 0;
  ...
  // decode OpenCV parameter to xiAPI parameter
  switch(property_id) {
    case cv::CAP_PROP_XI_TIMEOUT: return (double)timeout;
    case cv::CAP_PROP_XI_EXPOSURE:
      ximea_param = "exposure";
      value_type = xiTypeInteger;
      break;
...
void
CvCaptureCAM_XIMEA::errMsg(const char* msg, int errNum) const {
