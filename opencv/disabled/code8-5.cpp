...
string
categorizer::remove_extension(string full) {
...
categorizer::make_pos_neg() {
  ...
  for(int i = 0; i < categories; i++) {
    ...
    cout << "Category " << category << ": " << positive_data[category].rows << " Positives, " << negative_data[category].rows
         << " Negatives" << endl;
  }
}
