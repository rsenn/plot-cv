...
main(int argc, char* argv[]) {
  ...
  std::cout << "* => local logarithmic luminance compression allows details to be enhanced in low "
               "light conditions\n"
            << std::endl;
  ...
  std::cout << "* Benoit A., Caplier A., Durette B., Herault, J., \"USING HUMAN VISUAL SYSTEM "
               "MODELING FOR "
               "BIO-INSPIRED LOW LEVEL IMAGE PROCESSING\", Elsevier, Computer Vision and Image "
               "Understanding 114 "
  ...
  std::cout << "* Vision: Images, Signals and Neural Networks: Models of Neural Processing in "
               "Visual Perception "
               "(Progress in Neural Processing),By: Jeanny Herault, ISBN: 9814273686. WAPI (Tower "
               "ID): 113266891."
            << std::endl;
