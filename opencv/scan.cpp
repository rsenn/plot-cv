...
Mat
scan(cv::Mat img, jfloat x1, jfloat y1, jfloat x2, jfloat y2, jfloat x3, jfloat y3, jfloat x4, jfloat y4) {
...
Java_vi_pdfscanner_main_ScannerEngine_getMagicColorBitmap(JNIEnv* env, jobject thiz, jobject bitmap) {
  ...
  cv::adaptiveThreshold(dst, dst, 255, ADAPTIVE_THRESH_MEAN_C, THRESH_BINARY, 5, 4);
...
Java_vi_pdfscanner_main_ScannerEngine_getBWBitmap(JNIEnv* env, jobject thiz, jobject bitmap) {
  ...
  cv::threshold(dst, dst, 0, 255, THRESH_BINARY | THRESH_OTSU);
