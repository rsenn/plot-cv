...
static void
draw_subdiv_point(Mat& img, Point2f fp, Scalar color) {
  circle(img, fp, 3, color, FILLED, LINE_8, 0);
}

static void
draw_subdiv(Mat& img, Subdiv2D& subdiv, Scalar delaunay_color) {
#if 1
...
static void
locate_point(Mat& img, Subdiv2D& subdiv, Point2f fp, Scalar active_color) {
  int e0 = 0, vertex = 0;
...
static void
paint_voronoi(Mat& img, Subdiv2D& subdiv) {
