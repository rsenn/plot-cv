...
int
Entity::getXPos() { // get x and y coordinates of the car
  return Entity::xPos;
}
int
Entity::getYPos() {
...
void
Entity::setXPos(int x) { // set x and y coordinates of the car
  Entity::xPos = x;
}
void
...
Scalar
Entity::getHSVmin() { // getters for HSV min and max values
