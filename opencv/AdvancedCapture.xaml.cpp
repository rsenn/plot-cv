  ...
  try {
    ...
    if(chosenDevInfo->EnclosureLocation != nullptr &&
      ...
      m_bReversePreviewRotation = false;
              ...
              chosenDevInfo->EnclosureLocation->Panel == Windows::Devices::Enumeration::Panel::Front) {
      m_bRotateVideoOnOrientationChange = true;
...
AdvancedCapture::ReencodePhotoAsync(Windows::Storage::StorageFile ^ tempStorageFile,
...
AdvancedCapture::DisplayProperties_OrientationChanged(Platform::Object ^ sender) {
  ...
  bool counterclockwiseRotation =
      (previewMirroring && !m_bReversePreviewRotation) || (!previewMirroring && m_bReversePreviewRotation);
...
Windows::Storage::FileProperties::PhotoOrientation
AdvancedCapture::PhotoRotationLookup(Windows::Graphics::Display::DisplayOrientations displayOrientation,
