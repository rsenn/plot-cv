...
const char* sourceVideo = "G:\projs\cvcutter\source.avi";
...
backFilterImageBased() {
  ...
  Ucv::Mat frame, fgmask, fgimg;
  Ucv::Mat bgImg = imread("bgimg.jpg", IMREAD_COLOR).getUcv::Mat(ACCESS_READ);
  cap >> frame;
