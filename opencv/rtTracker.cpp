...
void
drawBox(vector<Point2f>& scene_corners, Mat& img_show)
...
void
drawAxis(vector<Point2f>& axis, Mat& img_show)
// Render 3D object
{
  //-- Draw lines between the corners (the mapped object in the scene - image_2 )
...
void
getCameraData(std::string filename, Mat& cameraMatrix2, Mat& distCoeffs2) {
