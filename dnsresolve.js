...
import { Socket, socket, socklen_t, AF_INET, SOCK_STREAM, IPPROTO_UDP, SockAddr as sockaddr_in/*ndelay, connect, sockaddr_in*/, select/*, fd_set, timeval, FD_SET, FD_CLR, FD_ISSET, FD_ZERO, errnos, send, recv*/ } from './socket.js';
