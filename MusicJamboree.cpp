...
void
removeStaves(Mat image, Vector<int> firstVec, Vector<int> endVec, Mat resultImage) {
...
void
createCookBook(Mat staveReg, int rightIndex) {
...
void
findNotes(Mat staveReg, Vector<float> staveLoc) {
