define('glAccum', dlsym(libGL,
  'glAccum'
), null, 'void', 'unsigned int', 'float');
export function glAccum(op, value) {
  return call('glAccum', op, value);
}

define('glAlphaFunc', dlsym(libGL,
  'glAlphaFunc'
), null, 'void', 'unsigned int', 'float');
...
define('glBindTexture', dlsym(libGL,
  'glBindTexture'
), null, 'void', 'unsigned int', 'unsigned int');
export function glBindTexture(target, texture) {
  return call('glBindTexture', target, texture);
}

define('glBitmap', dlsym(libGL,
  'glBitmap'
), null, 'void', 'int', 'int', 'float', 'float', 'float', 'float', 'void *');
...
define('glBlendFunc', dlsym(libGL,
  'glBlendFunc'
), null, 'void', 'unsigned int', 'unsigned int');
...
define('glCallLists', dlsym(libGL,
  'glCallLists'
), null, 'void', 'int', 'unsigned int', 'void *');
...
define('glClearAccum', dlsym(libGL,
  'glClearAccum'
), null, 'void', 'float', 'float', 'float', 'float');
export function glClearAccum(red, green, blue, alpha) {
  return call('glClearAccum', red, green, blue, alpha);
}

define('glClearColor', dlsym(libGL,
  'glClearColor'
), null, 'void', 'float', 'float', 'float', 'float');
...
define('glClipPlane', dlsym(libGL,
  'glClipPlane'
), null, 'void', 'unsigned int', 'void *');
export function glClipPlane(plane, equation) {
  return call('glClipPlane', plane, equation);
}

define('glColor3b', dlsym(libGL,
  'glColor3b'
), null, 'void', 'sint8', 'sint8', 'sint8');
...
define('glColor3d', dlsym(libGL,
  'glColor3d'
), null, 'void', 'double', 'double', 'double');
...
define('glColor3f', dlsym(libGL,
  'glColor3f'
), null, 'void', 'float', 'float', 'float');
...
define('glColor3i', dlsym(libGL,
  'glColor3i'
), null, 'void', 'int', 'int', 'int');
...
define('glColor3s', dlsym(libGL,
  'glColor3s'
), null, 'void', 'short', 'short', 'short');
...
define('glColor3ub', dlsym(libGL,
  'glColor3ub'
), null, 'void', 'unsigned char', 'unsigned char', 'unsigned char');
...
define('glColor3ui', dlsym(libGL,
  'glColor3ui'
), null, 'void', 'unsigned int', 'unsigned int', 'unsigned int');
...
define('glColor3us', dlsym(libGL,
  'glColor3us'
), null, 'void', 'uint16', 'uint16', 'uint16');
...
define('glColor4b', dlsym(libGL,
  'glColor4b'
), null, 'void', 'sint8', 'sint8', 'sint8', 'sint8');
...
define('glColor4d', dlsym(libGL,
  'glColor4d'
), null, 'void', 'double', 'double', 'double', 'double');
...
define('glColor4i', dlsym(libGL,
  'glColor4i'
), null, 'void', 'int', 'int', 'int', 'int');
...
define('glColor4s', dlsym(libGL,
  'glColor4s'
), null, 'void', 'short', 'short', 'short', 'short');
...
define('glColor4ub', dlsym(libGL,
  'glColor4ub'
), null, 'void', 'unsigned char', 'unsigned char', 'unsigned char', 'unsigned char');
...
define('glColor4ui', dlsym(libGL,
  'glColor4ui'
), null, 'void', 'unsigned int', 'unsigned int', 'unsigned int', 'unsigned int');
...
define('glColor4us', dlsym(libGL,
  'glColor4us'
), null, 'void', 'uint16', 'uint16', 'uint16', 'uint16');
...
define('glColorMask', dlsym(libGL,
  'glColorMask'
), null, 'void', 'unsigned char', 'unsigned char', 'unsigned char', 'unsigned char');
...
define('glColorMaterial', dlsym(libGL,
  'glColorMaterial'
), null, 'void', 'unsigned int', 'unsigned int');
...
define('glColorPointer', dlsym(libGL,
  'glColorPointer'
), null, 'void', 'int', 'unsigned int', 'int', 'void *');
export function glColorPointer(size, type, stride, pointer) {
  return call('glColorPointer', size, type, stride, pointer);
}

define('glCopyPixels', dlsym(libGL,
  'glCopyPixels'
), null, 'void', 'int', 'int', 'int', 'int', 'unsigned int');
export function glCopyPixels(x, y, width, height, type) {
  return call('glCopyPixels', x, y, width, height, type);
}

define('glCopyTexImage1D', dlsym(libGL,
  'glCopyTexImage1D'
), null, 'void', 'unsigned int', 'int', 'unsigned int', 'int', 'int', 'int', 'int');
export function glCopyTexImage1D(target,
  level,
  internalFormat,
  x,
  y,
...
define('glCopyTexImage2D', dlsym(libGL,
  'glCopyTexImage2D'
), null, 'void', 'unsigned int', 'int', 'unsigned int', 'int', 'int', 'int', 'int', 'int');
export function glCopyTexImage2D(target,
  level,
  internalFormat,
  x,
  y,
...
define('glCopyTexSubImage1D', dlsym(libGL,
  'glCopyTexSubImage1D'
), null, 'void', 'unsigned int', 'int', 'int', 'int', 'int', 'int');
...
define('glCopyTexSubImage2D', dlsym(libGL,
  'glCopyTexSubImage2D'
), null, 'void', 'unsigned int', 'int', 'int', 'int', 'int', 'int', 'int', 'int');
export function glCopyTexSubImage2D(target,
  level,
  xoffset,
  yoffset,
  x,
  ...
  return call('glCopyTexSubImage2D',
    target,
    level,
    xoffset,
    yoffset,
...
define('glDeleteLists', dlsym(libGL,
  'glDeleteLists'
), null, 'void', 'unsigned int', 'int');
export function glDeleteLists(list, range) {
  return call('glDeleteLists', list, range);
}

define('glDeleteTextures', dlsym(libGL,
  'glDeleteTextures'
), null, 'void', 'int', 'void *');
...
define('glDepthFunc', dlsym(libGL,
  'glDepthFunc'
), null, 'void', 'unsigned int');
export function glDepthFunc(func) {
  return call('glDepthFunc', func);
}

define('glDepthMask', dlsym(libGL,
  'glDepthMask'
), null, 'void', 'unsigned char');
export function glDepthMask(flag) {
  return call('glDepthMask', flag);
}

define('glDepthRange', dlsym(libGL,
  'glDepthRange'
), null, 'void', 'double', 'double');
...
define('glDisableClientState', dlsym(libGL,
...
define('glDrawArrays', dlsym(libGL,
  'glDrawArrays'
), null, 'void', 'unsigned int', 'int', 'int');
export function glDrawArrays(mode, first, count) {
  return call('glDrawArrays', mode, first, count);
}

define('glDrawBuffer', dlsym(libGL,
  'glDrawBuffer'
), null, 'void', 'unsigned int');
...
define('glDrawElements', dlsym(libGL,
  'glDrawElements'
), null, 'void', 'unsigned int', 'int', 'unsigned int', 'void *');
export function glDrawElements(mode, count, type, indices) {
  return call('glDrawElements', mode, count, type, indices);
}

define('glDrawPixels', dlsym(libGL,
  'glDrawPixels'
), null, 'void', 'int', 'int', 'unsigned int', 'unsigned int', 'void *');
...
define('glEdgeFlagPointer', dlsym(libGL,
  'glEdgeFlagPointer'
), null, 'void', 'int', 'void *');
...
define('glEnableClientState', dlsym(libGL,
  'glEnableClientState'
), null, 'void', 'unsigned int');
...
define('glEvalCoord1dv', dlsym(libGL,
  'glEvalCoord1dv'
), null, 'void', 'void *');
...
define('glEvalCoord1fv', dlsym(libGL,
  'glEvalCoord1fv'
), null, 'void', 'void *');
...
define('glEvalCoord2d', dlsym(libGL,
  'glEvalCoord2d'
), null, 'void', 'double', 'double');
...
define('glEvalCoord2dv', dlsym(libGL,
  'glEvalCoord2dv'
), null, 'void', 'void *');
...
define('glEvalCoord2f', dlsym(libGL,
  'glEvalCoord2f'
), null, 'void', 'float', 'float');
export function glEvalCoord2f(u, v) {
  return call('glEvalCoord2f', u, v);
}

define('glEvalCoord2fv', dlsym(libGL,
  'glEvalCoord2fv'
), null, 'void', 'void *');
...
define('glEvalMesh1', dlsym(libGL,
  'glEvalMesh1'
), null, 'void', 'unsigned int', 'int', 'int');
...
define('glEvalMesh2', dlsym(libGL,
  'glEvalMesh2'
), null, 'void', 'unsigned int', 'int', 'int', 'int', 'int');
...
define('glEvalPoint2', dlsym(libGL,
  'glEvalPoint2'
), null, 'void', 'int', 'int');
...
define('glFeedbackBuffer', dlsym(libGL,
  'glFeedbackBuffer'
), null, 'void', 'int', 'unsigned int', 'void *');
...
define('glFrontFace', dlsym(libGL,
  'glFrontFace'
), null, 'void', 'unsigned int');
...
define('glFrustum', dlsym(libGL,
  'glFrustum'
), null, 'void', 'double', 'double', 'double', 'double', 'double', 'double');
...
define('glGenTextures', dlsym(libGL,
  'glGenTextures'
), null, 'void', 'int', 'void *');
...
define('glGetBooleanv', dlsym(libGL,
  'glGetBooleanv'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetClipPlane', dlsym(libGL,
  'glGetClipPlane'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetDoublev', dlsym(libGL,
  'glGetDoublev'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetFloatv', dlsym(libGL,
  'glGetFloatv'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetIntegerv', dlsym(libGL,
  'glGetIntegerv'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetLightfv', dlsym(libGL,
  'glGetLightfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
export function glGetLightfv(light, pname, params) {
  return call('glGetLightfv', light, pname, params);
}

define('glGetLightiv', dlsym(libGL,
  'glGetLightiv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetMaterialfv', dlsym(libGL,
  'glGetMaterialfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetMaterialiv', dlsym(libGL,
  'glGetMaterialiv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetPixelMapfv', dlsym(libGL,
  'glGetPixelMapfv'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetPixelMapuiv', dlsym(libGL,
  'glGetPixelMapuiv'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetPixelMapusv', dlsym(libGL,
  'glGetPixelMapusv'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetPointerv', dlsym(libGL,
  'glGetPointerv'
), null, 'void', 'unsigned int', 'void *');
...
define('glGetPolygonStipple', dlsym(libGL,
  'glGetPolygonStipple'
), null, 'void', 'void *');
...
define('glGetString', dlsym(libGL,
  'glGetString'
), null, 'void *', 'unsigned int');
...
define('glGetTexEnvfv', dlsym(libGL,
  'glGetTexEnvfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetTexEnviv', dlsym(libGL,
  'glGetTexEnviv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetTexGendv', dlsym(libGL,
  'glGetTexGendv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetTexGenfv', dlsym(libGL,
  'glGetTexGenfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetTexGeniv', dlsym(libGL,
  'glGetTexGeniv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetTexImage', dlsym(libGL,
  'glGetTexImage'
), null, 'void', 'unsigned int', 'int', 'unsigned int', 'unsigned int', 'void *');
export function glGetTexImage(target, level, format, type, pixels) {
  return call('glGetTexImage', target, level, format, type, pixels);
}

define('glGetTexLevelParameterfv', dlsym(libGL,
...
define('glGetTexLevelParameteriv', dlsym(libGL,
...
define('glGetTexParameterfv', dlsym(libGL,
  'glGetTexParameterfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glGetTexParameteriv', dlsym(libGL,
  'glGetTexParameteriv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glIndexMask', dlsym(libGL,
  'glIndexMask'
), null, 'void', 'unsigned int');
...
define('glIndexPointer', dlsym(libGL,
  'glIndexPointer'
), null, 'void', 'unsigned int', 'int', 'void *');
...
define('glInterleavedArrays', dlsym(libGL,
  'glInterleavedArrays'
), null, 'void', 'unsigned int', 'int', 'void *');
...
define('glIsEnabled', dlsym(libGL,
  'glIsEnabled'
), null, 'unsigned char', 'unsigned int');
export function glIsEnabled(cap) {
  return call('glIsEnabled', cap);
}

define('glIsList', dlsym(libGL,
  'glIsList'
), null, 'unsigned char', 'unsigned int');
...
define('glIsTexture', dlsym(libGL,
  'glIsTexture'
), null, 'unsigned char', 'unsigned int');
...
define('glLightf', dlsym(libGL,
  'glLightf'
), null, 'void', 'unsigned int', 'unsigned int', 'float');
export function glLightf(light, pname, param) {
  return call('glLightf', light, pname, param);
}

define('glLightfv', dlsym(libGL,
  'glLightfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glLighti', dlsym(libGL,
  'glLighti'
), null, 'void', 'unsigned int', 'unsigned int', 'int');
export function glLighti(light, pname, param) {
  return call('glLighti', light, pname, param);
}

define('glLightiv', dlsym(libGL,
  'glLightiv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glLightModelf', dlsym(libGL,
  'glLightModelf'
), null, 'void', 'unsigned int', 'float');
...
define('glLightModelfv', dlsym(libGL,
  'glLightModelfv'
), null, 'void', 'unsigned int', 'void *');
...
define('glLightModeli', dlsym(libGL,
  'glLightModeli'
), null, 'void', 'unsigned int', 'int');
...
define('glLightModeliv', dlsym(libGL,
  'glLightModeliv'
), null, 'void', 'unsigned int', 'void *');
...
define('glLineStipple', dlsym(libGL,
  'glLineStipple'
), null, 'void', 'int', 'uint16');
...
define('glMap1d', dlsym(libGL,
  'glMap1d'
), null, 'void', 'unsigned int', 'double', 'double', 'int', 'int', 'void *');
export function glMap1d(target, u1, u2, stride, order, points) {
  return call('glMap1d', target, u1, u2, stride, order, points);
}

define('glMap1f', dlsym(libGL,
  'glMap1f'
), null, 'void', 'unsigned int', 'float', 'float', 'int', 'int', 'void *');
export function glMap1f(target, u1, u2, stride, order, points) {
  return call('glMap1f', target, u1, u2, stride, order, points);
}

define('glMap2d', dlsym(libGL,
  'glMap2d'
), null, 'void', 'unsigned int', 'double', 'double', 'int', 'int', 'double', 'double', 'int', 'int', 'void *');
export function glMap2d(target,
  u1,
  u2,
  ustride,
  uorder,
...
define('glMap2f', dlsym(libGL,
  'glMap2f'
), null, 'void', 'unsigned int', 'float', 'float', 'int', 'int', 'float', 'float', 'int', 'int', 'void *');
export function glMap2f(target,
  u1,
  u2,
  ustride,
  uorder,
...
define('glMaterialfv', dlsym(libGL,
  'glMaterialfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glMateriali', dlsym(libGL,
  'glMateriali'
), null, 'void', 'unsigned int', 'unsigned int', 'int');
...
define('glMaterialiv', dlsym(libGL,
  'glMaterialiv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glMatrixMode', dlsym(libGL,
  'glMatrixMode'
), null, 'void', 'unsigned int');
...
define('glNormalPointer', dlsym(libGL,
  'glNormalPointer'
), null, 'void', 'unsigned int', 'int', 'void *');
...
define('glPixelMapfv', dlsym(libGL,
  'glPixelMapfv'
), null, 'void', 'unsigned int', 'int', 'void *');
...
define('glPixelMapuiv', dlsym(libGL,
  'glPixelMapuiv'
), null, 'void', 'unsigned int', 'int', 'void *');
...
define('glPixelMapusv', dlsym(libGL,
  'glPixelMapusv'
), null, 'void', 'unsigned int', 'int', 'void *');
...
define('glPixelStoref', dlsym(libGL,
  'glPixelStoref'
), null, 'void', 'unsigned int', 'float');
...
define('glPixelStorei', dlsym(libGL,
  'glPixelStorei'
), null, 'void', 'unsigned int', 'int');
...
define('glPixelTransferf', dlsym(libGL,
  'glPixelTransferf'
), null, 'void', 'unsigned int', 'float');
...
define('glPixelTransferi', dlsym(libGL,
  'glPixelTransferi'
), null, 'void', 'unsigned int', 'int');
...
define('glPixelZoom', dlsym(libGL,
  'glPixelZoom'
), null, 'void', 'float', 'float');
...
define('glPolygonMode', dlsym(libGL,
  'glPolygonMode'
), null, 'void', 'unsigned int', 'unsigned int');
...
define('glPolygonOffset', dlsym(libGL,
  'glPolygonOffset'
), null, 'void', 'float', 'float');
...
define('glPolygonStipple', dlsym(libGL,
  'glPolygonStipple'
), null, 'void', 'void *');
...
define('glPushClientAttrib', dlsym(libGL,
  'glPushClientAttrib'
), null, 'void', 'unsigned int');
...
define('glRasterPos2d', dlsym(libGL,
  'glRasterPos2d'
), null, 'void', 'double', 'double');
...
define('glRasterPos2dv', dlsym(libGL,
  'glRasterPos2dv'
), null, 'void', 'void *');
...
define('glRasterPos2f', dlsym(libGL,
  'glRasterPos2f'
), null, 'void', 'float', 'float');
...
define('glRasterPos2fv', dlsym(libGL,
  'glRasterPos2fv'
), null, 'void', 'void *');
...
define('glRasterPos2i', dlsym(libGL,
  'glRasterPos2i'
), null, 'void', 'int', 'int');
...
define('glRasterPos2iv', dlsym(libGL,
  'glRasterPos2iv'
), null, 'void', 'void *');
...
define('glRasterPos2s', dlsym(libGL,
  'glRasterPos2s'
), null, 'void', 'short', 'short');
export function glRasterPos2s(x, y) {
  return call('glRasterPos2s', x, y);
}

define('glRasterPos2sv', dlsym(libGL,
  'glRasterPos2sv'
), null, 'void', 'void *');
...
define('glRasterPos3d', dlsym(libGL,
  'glRasterPos3d'
), null, 'void', 'double', 'double', 'double');
...
define('glRasterPos3dv', dlsym(libGL,
  'glRasterPos3dv'
), null, 'void', 'void *');
...
define('glRasterPos3f', dlsym(libGL,
  'glRasterPos3f'
), null, 'void', 'float', 'float', 'float');
...
define('glRasterPos3fv', dlsym(libGL,
  'glRasterPos3fv'
), null, 'void', 'void *');
...
define('glRasterPos3i', dlsym(libGL,
  'glRasterPos3i'
), null, 'void', 'int', 'int', 'int');
...
define('glRasterPos3iv', dlsym(libGL,
  'glRasterPos3iv'
), null, 'void', 'void *');
...
define('glRasterPos3s', dlsym(libGL,
  'glRasterPos3s'
), null, 'void', 'short', 'short', 'short');
...
define('glRasterPos3sv', dlsym(libGL,
  'glRasterPos3sv'
), null, 'void', 'void *');
...
define('glRasterPos4d', dlsym(libGL,
  'glRasterPos4d'
), null, 'void', 'double', 'double', 'double', 'double');
...
define('glRasterPos4dv', dlsym(libGL,
  'glRasterPos4dv'
), null, 'void', 'void *');
...
define('glRasterPos4f', dlsym(libGL,
  'glRasterPos4f'
), null, 'void', 'float', 'float', 'float', 'float');
...
define('glRasterPos4fv', dlsym(libGL,
  'glRasterPos4fv'
), null, 'void', 'void *');
...
define('glRasterPos4i', dlsym(libGL,
  'glRasterPos4i'
), null, 'void', 'int', 'int', 'int', 'int');
...
define('glRasterPos4iv', dlsym(libGL,
  'glRasterPos4iv'
), null, 'void', 'void *');
...
define('glRasterPos4s', dlsym(libGL,
  'glRasterPos4s'
), null, 'void', 'short', 'short', 'short', 'short');
...
define('glRasterPos4sv', dlsym(libGL,
  'glRasterPos4sv'
), null, 'void', 'void *');
...
define('glReadBuffer', dlsym(libGL,
  'glReadBuffer'
), null, 'void', 'unsigned int');
...
define('glReadPixels', dlsym(libGL,
  'glReadPixels'
), null, 'void', 'int', 'int', 'int', 'int', 'unsigned int', 'unsigned int', 'void *');
...
define('glRenderMode', dlsym(libGL,
  'glRenderMode'
), null, 'int', 'unsigned int');
export function glRenderMode(mode) {
  return call('glRenderMode', mode);
}

define('glRotated', dlsym(libGL,
  'glRotated'
), null, 'void', 'double', 'double', 'double', 'double');
...
define('glSelectBuffer', dlsym(libGL,
  'glSelectBuffer'
), null, 'void', 'int', 'void *');
...
define('glShadeModel', dlsym(libGL,
  'glShadeModel'
), null, 'void', 'unsigned int');
...
define('glStencilFunc', dlsym(libGL,
  'glStencilFunc'
), null, 'void', 'unsigned int', 'int', 'unsigned int');
export function glStencilFunc(func, ref, mask) {
  return call('glStencilFunc', func, ref, mask);
}

define('glStencilMask', dlsym(libGL,
  'glStencilMask'
), null, 'void', 'unsigned int');
...
define('glStencilOp', dlsym(libGL,
  'glStencilOp'
), null, 'void', 'unsigned int', 'unsigned int', 'unsigned int');
...
define('glTexCoord2d', dlsym(libGL,
  'glTexCoord2d'
), null, 'void', 'double', 'double');
...
define('glTexCoord2f', dlsym(libGL,
  'glTexCoord2f'
), null, 'void', 'float', 'float');
...
define('glTexCoord2i', dlsym(libGL,
  'glTexCoord2i'
), null, 'void', 'int', 'int');
...
define('glTexCoord2s', dlsym(libGL,
  'glTexCoord2s'
), null, 'void', 'short', 'short');
...
define('glTexCoord3d', dlsym(libGL,
  'glTexCoord3d'
), null, 'void', 'double', 'double', 'double');
...
define('glTexCoord3f', dlsym(libGL,
  'glTexCoord3f'
), null, 'void', 'float', 'float', 'float');
...
define('glTexCoord3i', dlsym(libGL,
  'glTexCoord3i'
), null, 'void', 'int', 'int', 'int');
...
define('glTexCoord3s', dlsym(libGL,
  'glTexCoord3s'
), null, 'void', 'short', 'short', 'short');
...
define('glTexCoord4d', dlsym(libGL,
  'glTexCoord4d'
), null, 'void', 'double', 'double', 'double', 'double');
...
define('glTexCoord4f', dlsym(libGL,
  'glTexCoord4f'
), null, 'void', 'float', 'float', 'float', 'float');
...
define('glTexCoord4i', dlsym(libGL,
  'glTexCoord4i'
), null, 'void', 'int', 'int', 'int', 'int');
...
define('glTexCoord4s', dlsym(libGL,
  'glTexCoord4s'
), null, 'void', 'short', 'short', 'short', 'short');
...
define('glTexCoordPointer', dlsym(libGL,
  'glTexCoordPointer'
), null, 'void', 'int', 'unsigned int', 'int', 'void *');
...
define('glTexGend', dlsym(libGL,
  'glTexGend'
), null, 'void', 'unsigned int', 'unsigned int', 'double');
export function glTexGend(coord, pname, param) {
  return call('glTexGend', coord, pname, param);
}

define('glTexGendv', dlsym(libGL,
  'glTexGendv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glTexImage1D', dlsym(libGL,
  'glTexImage1D'
), null, 'void', 'unsigned int', 'int', 'int', 'int', 'int', 'unsigned int', 'unsigned int', 'void *');
export function glTexImage1D(target,
  level,
  internalformat,
  width,
  border,
...
define('glTexImage2D', dlsym(libGL,
  'glTexImage2D'
), null, 'void', 'unsigned int', 'int', 'int', 'int', 'int', 'int', 'unsigned int', 'unsigned int', 'void *');
...
define('glTexParameterf', dlsym(libGL,
  'glTexParameterf'
), null, 'void', 'unsigned int', 'unsigned int', 'float');
...
define('glTexParameterfv', dlsym(libGL,
  'glTexParameterfv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glTexParameteri', dlsym(libGL,
  'glTexParameteri'
), null, 'void', 'unsigned int', 'unsigned int', 'int');
...
define('glTexParameteriv', dlsym(libGL,
  'glTexParameteriv'
), null, 'void', 'unsigned int', 'unsigned int', 'void *');
...
define('glTexSubImage1D', dlsym(libGL,
  'glTexSubImage1D'
), null, 'void', 'unsigned int', 'int', 'int', 'int', 'unsigned int', 'unsigned int', 'void *');
export function glTexSubImage1D(target,
  level,
  xoffset,
  width,
  format,
...
define('glTexSubImage2D', dlsym(libGL,
  'glTexSubImage2D'
), null, 'void', 'unsigned int', 'int', 'int', 'int', 'int', 'int', 'unsigned int', 'unsigned int', 'void *');
...
define('glTranslated', dlsym(libGL,
  'glTranslated'
), null, 'void', 'double', 'double', 'double');
...
define('glTranslatef', dlsym(libGL,
  'glTranslatef'
), null, 'void', 'float', 'float', 'float');
...
define('glVertexPointer', dlsym(libGL,
  'glVertexPointer'
), null, 'void', 'int', 'unsigned int', 'int', 'void *');
