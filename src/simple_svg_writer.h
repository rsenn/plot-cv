...
public:
  ...
  //</svg>
  Document() : GroupBase("svg", {{"xmlns", std::string("http://www.w3.org/2000/svg")}, {"xmlns:xlink", std::string("http://www.w3.org/1999/xlink")}, {"xmlns:inkscape", std::string("http://www.inkscape.org/namespaces/inkscape")}}) {}
  Document(double width, double height) : GroupBase("svg", {{"width", to_string(width)}, {"height", to_string(height)}, {"xmlns", std::string("http://www.w3.org/2000/svg")}, {"xmlns:xlink", std::string("http://www.w3.org/1999/xlink")}, {"xmlns:inkscape", std::string("http://www.inkscape.org/namespaces/inkscape")}}) {}
