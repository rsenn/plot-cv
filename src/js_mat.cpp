  ...
  if(m->depth() == CV_16U && m->channels() > 1) {
    ...
    if(bytes <= 1) {
      ...
      /*  JSMatSizeData dim;
        ...
        for(idx = 0; idx < v.size(); idx++) m->at<uint32_t>(idx / dim.cols, idx % dim.cols) = v[idx];*/
    }
  }
...
const JSCFunctionListEntry js_mat_static_funcs[] = {
    JS_CFUNC_DEF("getRotationMatrix2D", 3, js_mat_getrotationmatrix2d),        JS_PROP_INT32_DEF("CV_8U", CV_MAKETYPE(CV_8U, 1), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_8S", CV_MAKETYPE(CV_8S, 1), JS_PROP_ENUMERABLE),     JS_PROP_INT32_DEF("CV_16U", CV_MAKETYPE(CV_16U, 1), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_16S", CV_MAKETYPE(CV_16S, 1), JS_PROP_ENUMERABLE),   JS_PROP_INT32_DEF("CV_32S", CV_MAKETYPE(CV_32S, 1), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_32F", CV_MAKETYPE(CV_32F, 1), JS_PROP_ENUMERABLE),   JS_PROP_INT32_DEF("CV_64F", CV_MAKETYPE(CV_64F, 1), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_8UC1", CV_MAKETYPE(CV_8U, 1), JS_PROP_ENUMERABLE),   JS_PROP_INT32_DEF("CV_8UC2", CV_MAKETYPE(CV_8U, 2), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_8UC3", CV_MAKETYPE(CV_8U, 3), JS_PROP_ENUMERABLE),   JS_PROP_INT32_DEF("CV_8UC4", CV_MAKETYPE(CV_8U, 4), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_8SC1", CV_MAKETYPE(CV_8S, 1), JS_PROP_ENUMERABLE),   JS_PROP_INT32_DEF("CV_8SC2", CV_MAKETYPE(CV_8S, 2), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_8SC3", CV_MAKETYPE(CV_8S, 3), JS_PROP_ENUMERABLE),   JS_PROP_INT32_DEF("CV_8SC4", CV_MAKETYPE(CV_8S, 4), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_16UC1", CV_MAKETYPE(CV_16U, 1), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_16UC2", CV_MAKETYPE(CV_16U, 2), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_16UC3", CV_MAKETYPE(CV_16U, 3), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_16UC4", CV_MAKETYPE(CV_16U, 4), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_16SC1", CV_MAKETYPE(CV_16S, 1), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_16SC2", CV_MAKETYPE(CV_16S, 2), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_16SC3", CV_MAKETYPE(CV_16S, 3), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_16SC4", CV_MAKETYPE(CV_16S, 4), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_32SC1", CV_MAKETYPE(CV_32S, 1), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_32SC2", CV_MAKETYPE(CV_32S, 2), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_32SC3", CV_MAKETYPE(CV_32S, 3), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_32SC4", CV_MAKETYPE(CV_32S, 4), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_32FC1", CV_MAKETYPE(CV_32F, 1), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_32FC2", CV_MAKETYPE(CV_32F, 2), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_32FC3", CV_MAKETYPE(CV_32F, 3), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_32FC4", CV_MAKETYPE(CV_32F, 4), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_64FC1", CV_MAKETYPE(CV_64F, 1), JS_PROP_ENUMERABLE), JS_PROP_INT32_DEF("CV_64FC2", CV_MAKETYPE(CV_64F, 2), JS_PROP_ENUMERABLE),
    JS_PROP_INT32_DEF("CV_64FC3", CV_MAKETYPE(CV_64F, 3), JS_PROP_ENUMERABLE)};
