...
main(int argc, char** argv) {
  ...
  CommandLineParser parser(argc,
                           ...
                           "{ model_filename f  |      | (required) path to binary file storing the trained model which is to be loaded "
                           "[example - /data/file.dat]}"
                           "{ video v           |      | (required) path to video in which face landmarks have to be detected.[example - "
                           "/data/video.avi] }"
