...
JSValue js_contour2i_new(JSContext*, const std::vector<cv::Point_<int>>& points);
JSValue js_contour_new(JSContext*, const std::vector<cv::Point_<float>>& points);
...
int64_t js_array_to_vector(JSContext*, JSValue arr, std::vector<Value>& out);
