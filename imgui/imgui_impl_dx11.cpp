...
//  displayed in the About Window. 2018-08-01: DirectX11: Querying for IDXGIFactory instead of
//  IDXGIFactory1 to increase compatibility. 2018-07-13: DirectX11: Fixed unreleased resources in
//  Init and Shutdown functions. 2018-06-08: Misc: Extracted imgui_impl_dx11.cpp/.h away from the
//  old combined DX11+Win32 example. 2018-06-08: DirectX11: Use draw_data->DisplayPos and
//  draw_data->DisplaySize to setup projection matrix and clipping rectangle. 2018-02-16: Misc:
//  Obsoleted the io.RenderDrawListsFn callback and exposed ImGui_ImplDX11_RenderDrawData() in the
//  .h file so you can call it yourself. 2018-02-06: Misc: Removed call to ImGui::Shutdown() which
//  is not available from 1.60 WIP, user needs to call CreateContext/DestroyContext themselves.
