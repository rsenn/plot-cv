...
main(int, char**) {
  ...
  // For the browser using Emscripten, we are going to use WebGL1 with GL ES2. See the Makefile. for
  // requirement details. It is very likely the generated file won't work in many browsers. Firefox
  // is the only sure bet, but I have successfully run this code on Chrome for Android for example.
