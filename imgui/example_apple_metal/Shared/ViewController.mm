...
- (void)viewDidLoad {
  ...
  // our window, we'd want to be much more careful than just ingesting the complete event stream,
  // though we do make an effort to be good citizens by passing along events when Dear ImGui doesn't
  // want to capture.
