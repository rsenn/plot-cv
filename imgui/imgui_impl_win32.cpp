...
//  2019-01-17: Misc: Using GetForegroundWindow()+IsChild() instead of GetActiveWindow() to be
//  compatible with windows created in a different thread or parent. 2019-01-17: Inputs: Added
//  support for mouse buttons 4 and 5 via WM_XBUTTON* messages. 2019-01-15: Inputs: Added support
//  for XInput gamepads (if ImGuiConfigFlags_NavEnableGamepad is set by user application).
//  2018-11-30: Misc: Setting up io.BackendPlatformName so it can be displayed in the About Window.
//  2018-06-29: Inputs: Added support for the ImGuiMouseCursor_Hand cursor.
//  2018-06-10: Inputs: Fixed handling of mouse wheel messages to support fine position messages
//  (typically sent by track-pads). 2018-06-08: Misc: Extracted imgui_impl_win32.cpp/.h away from
//  the old combined DX9/DX10/DX11/DX12 examples. 2018-03-20: Misc: Setup io.BackendFlags
//  ImGuiBackendFlags_HasMouseCursors and ImGuiBackendFlags_HasSetMousePos flags + honor
//  ImGuiConfigFlags_NoMouseCursorChange flag. 2018-02-20: Inputs: Added support for mouse cursors
//  (ImGui::GetMouseCursor() value and WM_SETCURSOR message handling). 2018-02-06: Inputs: Added
//  mapping for ImGuiKey_Space. 2018-02-06: Inputs: Honoring the io.WantSetMousePos by repositioning
//  the mouse (when using navigation and ImGuiConfigFlags_NavMoveMouse is set). 2018-02-06: Misc:
