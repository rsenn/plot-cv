...
// Forward Mouse/Keyboard events to dear imgui OSX back-end. It returns true when imgui is expecting
// to use the event.
...
- (void)applicationDidFinishLaunching:(NSNotification*)aNotification {
  ...
  ImGuiExampleView* view =
      [[ImGuiExampleView alloc] initWithFrame:self.window.frame pixelFormat:format];
  format = nil;
