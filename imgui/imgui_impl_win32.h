...
// inputs. Intentionally commented out to avoid dragging dependencies on <windows.h> types. You can
// COPY this line into your .cpp code instead.
/*
IMGUI_IMPL_API LRESULT  ImGui_ImplWin32_WndProcHandler(HWND hWnd, UINT msg, WPARAM wParam, LPARAM
lParam);
*/
