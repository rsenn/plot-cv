...
//  2019-XX-XX: *BREAKING CHANGE*: Vulkan: Added ImageCount/MinImageCount fields in
//  ImGui_ImplVulkan_InitInfo, required for initialization (was previously a hard #define
//  IMGUI_VK_QUEUED_FRAMES 2). Added ImGui_ImplVulkan_SetMinImageCount(). 2019-XX-XX: Vulkan: Added
...
//  ImGui_ImplVulkan_RenderDrawData() to be consistent with other bindings. 2018-06-08: Misc:
...
void
ImGui_ImplVulkanH_CreateWindow(VkInstance instance,
...
void
ImGui_ImplVulkanH_DestroyFrameRenderBuffers(VkDevice device,
                                            ImGui_ImplVulkanH_FrameRenderBuffers* buffers,
                                            const VkAllocationCallbacks* allocator) {
...
void
ImGui_ImplVulkanH_DestroyWindowRenderBuffers(VkDevice device,
                                             ImGui_ImplVulkanH_WindowRenderBuffers* buffers,
                                             const VkAllocationCallbacks* allocator) {
