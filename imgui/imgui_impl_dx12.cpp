...
//  displayed in the About Window. 2018-06-12: DirectX12: Moved the ID3D12GraphicsCommandList*
//  parameter from NewFrame() to RenderDrawData(). 2018-06-08: Misc: Extracted
//  imgui_impl_dx12.cpp/.h away from the old combined DX12+Win32 example. 2018-06-08: DirectX12: Use
//  draw_data->DisplayPos and draw_data->DisplaySize to setup projection matrix and clipping
//  rectangle (to ease support for future multi-viewport). 2018-02-22: Merged into master with all
//  Win32 code synchronized to other examples.
...
void
ImGui_ImplDX12_RenderDrawData(ImDrawData* draw_data, ID3D12GraphicsCommandList* ctx) {
...
ImGui_ImplDX12_CreateFontsTexture() {
  ...
  // Upload texture to graphics system
  {
    ...
    g_pd3dDevice->CreateCommittedResource(&props,
                                          D3D12_HEAP_FLAG_NONE,
                                          &desc,
