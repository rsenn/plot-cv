...
(function(globalObj) {
  ...
  const SymSpecies = Util.tryCatch((() => Symbol), ((sym) => sym.species));
  ...
  Object.defineProperties(Point.prototype, { X: { get() {
    return this.x;
  } }, Y: { get() {
    return this.y;
  } } });
  ...
  */ Point.prototype.toString = function(opts = {}) {
  ...
  for(let name of [ 'clone', 'comp', 'neg', 'sides', 'dimension', 'toString', //'toSource',
    
  'toCSS', 'sub', 'diff', 'add', 'sum', 'distance' ]) {
  ...
  */
  ...
  Object.defineProperty(Line.prototype, 'a', { get() {
    return Line.a(this);
  }, set(value) {
  ...
  Object.defineProperty(Line.prototype, 'b', { get() {
    return Line.b(this);
  }, set(value) {
    if(!(value instanceof Point)) value = Point(value);
    this.x2 = value.x;
  ...
  Object.defineProperty(Line.prototype, 0, { get() {
    return this.a;
  }, set(v) {
    this.a = v;
  }, enumerable: false });
  
  Object.defineProperty(Line.prototype, 1, { get() {
    return this.b;
  }, set(v) {
    this.b = v;
  }, enumerable: false });
  ...
  */
  ...
  Object.defineProperty(Line.prototype, 'slope', { get() {
    return { x: this.x2 - this.x1, y: this.y2 - this.y1 }
  } });
  ...
  Object.defineProperty(Line.prototype, 'cross', { get() {
    const { x1, x2, y1, y2 } = this;
    return x1 * y2 - y1 * x2;
  } });
  
  Object.defineProperty(Line.prototype, 'dot', { get() {
    const { x1, x2, y1, y2 } = this;
    return x1 * x2 + y1 * y2;
  } });
  ...
  Object.defineProperty(Rect.prototype, 'x1', { get() {
    return this.x;
  }, set(value) {
  ...
  Object.defineProperty(Rect.prototype, 'x2', { get() {
    return this.x + this.width;
  }, set(value) {
    this.width = value - this.x;
  }, enumerable: true });
  
  Object.defineProperty(Rect.prototype, 'y1', { get() {
    return this.y;
  }, set(value) {
  ...
  Object.defineProperty(Rect.prototype, 'y2', { get() {
    return this.y + this.height;
  }, set(value) {
    this.height = value - this.y;
  } });
  
  Object.defineProperty(Rect.prototype, 'area', { get() {
    return Rect.prototype.getArea.call(this);
  } });
  
  const getSize = Util.memoize(((rect) => Util.bindProperties(new Size(0, 0), rect, [ 'width', 'height' ], ((k) => {
    console.log('gen', { k });
  ...
  Object.defineProperty(Rect.prototype, 'center', { get() {
    return Rect.center(this);
  } });
  Rect.prototype.getSize = Util.memoize;
  
  Object.defineProperty(Rect.prototype, 'size', { get() {
    let ret = getSize(this);
    console.log('getSize( ) =', ret);
    return ret;
  } });
  
  Object.defineProperty(Rect.prototype, 'point', { get() {
  ...
  for(let name of [ 'clone', 'corners', 'isSquare', 'getArea', 'toString', //'toSource',
    
  'points', 'toCSS', 'toTRBL', 'toPoints', 'equals' ]) {
  ...
  Object.defineProperty(TRBL.prototype, 'inset', { get() {
    return ((rect) => Rect.inset(rect, this));
  } });
  
  Object.defineProperty(TRBL.prototype, 'outset', { get() {
  ...
  /* --- concatenanted 'lib/dom/iterator.js' --- */
  //Example usage:
  ...
  Object.defineProperty(PointList.prototype, 'size', { get() {
  ...
  PointList.prototype.bbox = function() {
    ...
    let ret = { x1: first.x, x2: first.x, y1: first.y, y2: first.y, toString() {
  ...
  PointList.prototype.lines = function(closed = false) {
    ...
    const iterableObj = { [Symbol.iterator]() {
      let step = 0;
  ...
  PointList.prototype[Symbol.toStringTag] = function(sep = (',', prec)) {
    return ((Array.prototype.map.call(this, ((point) => point.round(prec)))).map(((point) => `${point.x}${sep}${point.y}`))).join(' ');
  };
  ...
  Polyline.prototype.inside = function(point) {
    let i, j, c = false, nvert = this.length;
  ...
  Util.define(PointList, { get [Symbol.species]() {
    return PointList;
  } });
  ...
  */
  ...
  Object.defineProperty(Matrix, Symbol.species, { get() {
    return Matrix;
  } });
  ...
  const MatrixProps = ((obj = {}) => (Object.entries(keyIndexes)).reduce(((acc, [ k, i ]) => ({ ...acc, [[k]]: { get() {
    return this.i;
  }, set(v) {
    this.i = v;
  }, enumerable: true } })), obj));
  ...
  Matrix.prototype.decompose = function(degrees = (false, useLU = true)) {
    let a = this[0], b = this[3], c = this[1], d = this[4];
    let translate = { x: this[2], y: this[5] }, rotation = 0, scale = { x: 1, y: 1 }, skew = { x: 0, y: 0 };
    let determ = a * d - b * c, r, s;
  ...
  Object.defineProperty(Circle.prototype, 'center', { get() {
  ...
  Object.defineProperty(Transformation, Symbol.hasInstance, { value(inst) {
  ...
  Util.inherit(TransformationList.prototype, { // concat,
      
  copyWithin, find, findIndex, lastIndexOf, pop, shift, //   slice,
      
  //splice,
      
  includes, indexOf, entries, //  filter,
      
  //  map,
      
  every, some, reduce, reduceRight }, { [Symbol.iterator]() {
  ...
  function getSqSegDist(p, p1, p2) {
    let x = p1[0], y = p1[1], dx = p2[0] - x, dy = p2[1] - y, t;
  ...
  Util.weakAssign(globalObj, { Transformation, Rotation, Translation, Scaling, MatrixTransformation, TransformationList });
  Util.weakAssign(globalObj, { Vector });
  Util.weakAssign(globalObj, { simplifyRadialDist, simplifyDPStep, simplifyDouglasPeucker, simplify });
